        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800">
                    <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-6">Editar Registro</h1>
                    ...
                    <form action="{{ route('diaries.update', $diary->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date" id="date" class="form-input mt-1 block w-full" value="{{ $diary->date }}" required>
                        </div>
